const sections = [
  {
    ...
    details:
      "Bacterial colony analysis reveals how product materials and chemical treatments influence microbial proliferation. Products with higher synthetic content or chemical additives may create environments more conducive to bacterial growth, while natural fibres and breathable designs may inhibit it.",
  },
  {
    subject: "Chemistry",
    emoji: "⚗️",
    ...
    metric:
      "pH value (target: 5.5–7.0), binary presence of additives, material classification",
    details:
  ...
  },
  {
    ...
    metric:
      "Absorbency ratio (g/g), absorption rate (s/5 mL), leakage resistance (g)",
    details:
      "Three physics experiments. Capacity measures total fluid held per gram of product. Rate measures speed of absorption for 5 mL. Leakage pressure (optional) measures weight tolerance before leaking — skipped for tampons as the test design is not applicable.",
  },
  {
    subject: "ESS",
    emoji: "🌱",
...
export default function Methodology() {
  return (
    <div className="px-8 lg:px-16 py-16">
      ...
      <div className="mb-12">
        <span className="text-sm font-semibold tracking-widest text-rose-500 uppercase">Methodology</span>
        <h1 className="text-4xl font-bold text-slate-950 mt-2 mb-3">How We Tested</h1>
        <p className="text-lg text-slate-700 max-w-3xl">
          Each product was evaluated across four independent subject
          investigations. All experiments conducted in the school laboratory on
          13–16 May.
        </p>
      </div>
      ...
      <div className="space-y-8">
        {sections.map(({ subject, emoji, aim, method, metric, details }) => (
          <div
            key={subject}
            className="border border-slate-200 rounded-2xl p-8 shadow-sm hover:-translate-y-0.5 hover:shadow-md transition-all duration-200"
          >
            ...
            <p className="text-base text-slate-700 mb-4 italic">{aim}</p>
