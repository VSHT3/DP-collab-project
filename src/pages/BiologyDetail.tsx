...
function RiskRow({
  ...
  cells: { risk: string; desc: string; color: string }[];
}) {
  return (
      ...
      <div className="max-w-none mx-auto">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <p className="text-sm text-black italic">
            Brand comparison from the file (ratings are by product
            type/material, not lab tests of these exact brands).
          </p>
          <div className="flex gap-2 shrink-0">
            <span className="px-4 py-1.5 text-sm font-bold uppercase rounded-full bg-rose-100 text-rose-700">
              HIGH
            </span>
            <span className="px-4 py-1.5 text-sm font-bold uppercase rounded-full bg-orange-100 text-orange-700">
              MODERATE
            </span>
            <span className="px-4 py-1.5 text-sm font-bold uppercase rounded-full bg-slate-100 text-black">
              LOW
            </span>
          </div>
        </div>
        ...
        <div className="border border-slate-200 rounded-2xl overflow-hidden shadow-sm mb-8">
          <div className="bg-slate-800 px-8 py-5">
            <h2 className="text-white font-bold text-base flex items-center gap-2">
              <span className="text-lg">✏️</span> Chemical exposure:
              VOCs/phthalates, metals, PFAS, bleaching residues
            </h2>
          </div>
          <div className="p-8">
            <div className="overflow-x-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-8 pb-8">
            <div className="border border-slate-200 rounded-xl p-5">
              <h3 className="font-bold text-base text-black mb-3">
                What is mandatory / official?
              </h3>
              <ul className="text-sm text-black space-y-1.5 list-disc list-inside">
                <li>
                  EU Cosmetics Regulation (EC) No 1223/2009 governs fragrance
                  allergen labeling
                </li>
                <li>
                  FDA classifies tampons as Class II medical devices (510(k)
                  clearance)
                </li>
                <li>
                  ISO 81121:2020 sets absorbency standards, not chemical safety
                  thresholds
                </li>
              </ul>
            </div>
            <div className="border border-slate-200 rounded-xl p-5">
              <h3 className="font-bold text-base text-black mb-3">
                Why safe / not fully settled?
              </h3>
              <ul className="text-sm text-black space-y-1.5 list-disc list-inside">
                <li>
                  Vaginal epithelium absorbs chemicals more readily than
                  external skin
                </li>
                <li>
                  No legally binding limits for heavy metals (Pb, As, Cd) in
                  menstrual products
                </li>
                <li>
                  PFAS found in 25% of reusable products despite no regulatory
                  limits
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-slate-200 px-8 py-5">
            <div className="flex items-start gap-4">
              ...
              <p className="text-sm text-black">
                Choose unscented products with natural, breathable materials.
                Change tampons every 4–6 hours and use the lowest absorbency
                needed. Wash cloth pads thoroughly, avoid fabric softeners, and
                check for PFAS-free claims on reusable products.
              </p>
            </div>
          </div>
        </div>
        ...
        <p className="text-sm text-black italic mt-4">
          *Cloth-pad risk becomes higher if it is not fully washed/dried or if
          irritating detergent remains.
        </p>
        ...
        <div className="mt-8 p-8 bg-slate-50 rounded-2xl border border-slate-200">
          <p className="font-bold text-base text-black text-center">
            Key message: tampons create a clear TSS pathway, pads mainly differ
            by breathability, fragrance/synthetics, and washing hygiene.
          </p>
        </div>
      </div>
    </div>
